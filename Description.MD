C# library that allows to create, view and edit a list of books. Each book has a title, an author,
and number of pages. The library should provide following functionality:
